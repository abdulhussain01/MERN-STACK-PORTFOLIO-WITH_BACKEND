...
} from "@/strore/slices/applicationSlice";
...
const Dashboard = () => {
  ...
  const { softwareApplication, error, message, loading } = useSelector(
                ...
                <Card>
                  ...
                  <CardContent>
                    <Table>
                      ...
                      <TableBody>
                        {softwareApplication &&
                        softwareApplication.length > 0 ? (
                          softwareApplication.map((element) => (
                            <TableRow className="bg-accent" key={element._id}>
